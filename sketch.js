...
function lightviolet(){
  if(frameCount % 600 === 0){
    ...
    vio.x = Math.round(random(50,1000));
    vio.addImage(violet);
    vio.scale = 0.5;
    vio.velocityY = 10;
    vio.lifetime = 100;
...
function lightwhite(){
  if(frameCount % 300 === 0){
    ...
    wh.x = Math.round(random(100,2000));
    wh.addImage(white);
    wh.scale = 0.4;
    wh.velocityY = 10;
    wh.lifetime = 100;
...
function lightyellow(){
  if(frameCount % 200 === 0){
    ...
    yel.x = Math.round(random(200,1000));
    yel.addImage(yellow);
    yel.scale = 0.5;
    yel.velocityY = 10;
    yel.lifetime = 100;
